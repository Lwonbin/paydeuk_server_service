...
import com.tower_of_fisa.paydeuk_server_service.service.admin.AdminUserService;
...
public class AdminUserController {
    ...
    @GetMapping("/stats")
    @Operation(summary = "ADMIN_USER_02 : 사용자 통계 조회", description = "전체 사용자 수, 활성 사용자 수, 비활성 사용자 수를 조회한다.")
    @ApiResponses(value = {
