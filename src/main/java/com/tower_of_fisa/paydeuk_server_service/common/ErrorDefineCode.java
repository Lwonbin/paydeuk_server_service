...
public enum ErrorDefineCode {
  ...
  VERIFICATION_TOKEN_NULL("ERR_07", "토큰 발급 응답이 null입니다."),
  VERIFICATION_RESPONSE_NULL("ERR_08", "인증 응답의 response 필드가 null입니다."),
  VERIFICATION_ACCESS_TOKEN_NULL("ERR_09", "인증 응답의 access_token 필드가 null입니다."),
  VERIFICATION_RESULT_NULL("ERR_10", "인증 결과 조회 응답이 null입니다."),
  ;
