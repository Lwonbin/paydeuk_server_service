...
public class AdminUserService {
    ...
    /**
     * [사용자 통계 조회]
     * 전체 사용자 수, 활성 사용자 수, 비활성 사용자 수를 조회한다.
    ...
    /**
     * [User Entity → UserListResponse DTO 변환]
     * 사용자 엔티티를 외부 노출용 응답 DTO로 변환한다.
     * 이는 엔티티의 내부 구조나 민감 정보를 그대로 노출하지 않기 위함이며,
     * 클라이언트에게 필요한 필드만 전달하고, API 응답 형식을 통제하기 위한 목적이다.
