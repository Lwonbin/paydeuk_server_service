...
public class MerchantService {
    ...
    /**
     * [Merchant 탐색]
     * merchantId를 통해 Merchant DB를 탐색 하여 탐색 결과를 반환한다.
    ...
    /**
     * [Merchant Update]
     * merchantId를 통해 Merchant DB를 탐색 하여 탐색 결과의 활성화 상태 값을 변경한다.
     *
     * @param merchantId Long - 가맹점 ID
     * @param isActive boolean - update할려는 상태 값
     * void
     */
    @Transactional
    ...
    /**
     * [Merchant delete]
     * merchantId를 통해 Merchant DB를 탐색 하여 탐색 결과의 삭제 상태 값을 변경한다.
     *
     * @param merchantId Long - 가맹점 ID
     * void
     */
