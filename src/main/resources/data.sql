...
VALUES ('현대카드 M', 'CREDIT', 'https://paydeuk-s3-bucket.s3.ap-northeast-2.amazonaws.com/hyundaiM.png', 30000, 'HYUNDAI',
       ...
       ('삼성카드 taptap O', 'CREDIT', 'https://paydeuk-s3-bucket.s3.ap-northeast-2.amazonaws.com/samsungTaptap.png', 10000,
        'SAMSUNG', NOW(), NOW()),
       ('카드의 정석 오하CHECK', 'DEBIT', 'https://paydeuk-s3-bucket.s3.ap-northeast-2.amazonaws.com/ohacheck.png', 0, 'WOORI',
        NOW(), NOW());
...
VALUES ('기본혜택', '국내외 가맹점 1.5% M포인트 적립', 'point', 1, NULL, NOW(), NOW()),          -- 현대카드 M / 전 가맹점 (1)
       ...
       ('[오늘 하루 SHOPPING] 온라인 쇼핑', '무신사 5% 캐시백', 'CASHBACK', 1, 8, NOW(), NOW()), -- 우리카드 카드의 정석오하CHECK / 무신사 (15)
       ('[오늘 하루 SHOPPING] 온라인 쇼핑', '쿠팡 5% 캐시백', 'CASHBACK', 1, 7, NOW(), NOW()),  -- 우리카드 카드의 정석오하CHECK / 쿠팡 (16)
       ('[오늘 하루 EAT] 카페', '스타벅스 5% 캐시백', 'CASHBACK', 1, 1, NOW(), NOW()),         -- 우리카드 카드의 정석오하CHECK / 스타벅스 (17)
       ('[오늘 하루 SHOPPING] 배달앱', '배달의 민족 5% 캐시백', 'CASHBACK', 1, 3, NOW(), NOW()), -- 우리카드 카드의 정석오하CHECK / 배달의 민족 (18)
       ('[오늘 하루 SHOPPING] 배달앱', '마켓컬리 5% 캐시백', 'CASHBACK', 1, 2, NOW(), NOW()),   -- 우리카드 카드의 정석오하CHECK / 마켓컬리 (19)
       ('[오늘 하루 PLAY] 디지털구독', '넷플릭스 5% 캐시백', 'CASHBACK', 1, 4, NOW(), NOW());
-- 우리카드 카드의 정석오하CHECK / 넷플릭스 (20)
...
VALUES (2, NULL, 10000, 'MONTHLY_DISCOUNT_LIMIT', NOW(), NOW()),  -- 현대카드 M 추가혜택 컬리
       ...
       (20, NULL, 1000, 'PER_TRANSACTION_LIMIT', NOW(), NOW());
-- 우리카드 카드의정석 오하CHECK [오늘 하루 PLAY] OTT 넷플릭스
...
VALUES (1, 1, 'rate', 1.5, NOW(), NOW()),      -- 현대카드 M 기본혜택 전가맹점
       ...
       (15, 11, 'rate', 5, NOW(), NOW());
-- 우리카드 카드의 정석 오하CHECK [오늘 하루 PLAY] OTT 넷플릭스
