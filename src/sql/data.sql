...
-- MERCHANT TABLE
INSERT INTO merchant ( name, is_active, commission_rate, business_number, manager_name, phone, manager_phone, category, created_at, updated_at)
VALUES
('스타벅스', 1, '10%', '123-45-67890', '김스벅', '02-1234-5678', '010-8765-4321', 'food_beverage', NOW(), NOW()),
...
VALUES
( '기본혜택', '국내외 가맹점 1.5% M포인트 적립', 'point', 1, NULL, NOW(), NOW() ),
...
VALUES
( 2, NULL, 10000, 'MONTHLY_DISCOUNT_LIMIT', NOW(), NOW() ),
